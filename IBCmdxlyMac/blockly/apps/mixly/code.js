...
Code.initLanguage = function() {
  ...
  var categories = ['catInOut', 'catControl', 'catMath', 'catText', 'catLists',
                    ...
                    'IBC','IBCModule','IBCModule_Core','IBCModule_Motor',
                    'IBCSensor','IBCSensor_Colorled','IBCSensor_Buzzer','IBCSensor_Crash',
                    'IBCSensor_LineFinder','IBCSensor_Mic','IBCSensor_Light','IBCSensor_Infrared_receiver'];
