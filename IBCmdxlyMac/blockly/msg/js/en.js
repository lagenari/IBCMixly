...
var MSG = {
  ...
  IBCModule:"Module",
  IBCModule_Core:"Core",
  IBCModule_Motor:"Motor",
  IBCSensor:"Sensor",
  IBCSensor_Colorled:"Color LED",
  IBCSensor_Buzzer:"Buzzer",
  IBCSensor_Crash:"Crash",
  IBCSensor_LineFinder:"Line Finder",
  IBCSensor_Mic:"MIC",
  IBCSensor_Light:"Light-A",
  IBCSensor_Infrared_receiver:"IR Receiver",
  catLuxe:"LuxeRobot",
  tab_blocks: "Blocks",
  tab_arduino: "Code",
...
Blockly.REMOTE_CONTRO_KEY = 'Receive remote control signal';
Blockly.Infrared_receiver_POWER='POWER';
Blockly.Infrared_receiver_A='A';
Blockly.Infrared_receiver_B='B';
Blockly.Infrared_receiver_C='C';
Blockly.Infrared_receiver_D='D';
Blockly.Infrared_receiver_E='E';
Blockly.Infrared_receiver_LEFT='LEFT';
Blockly.Infrared_receiver_RIGHT='RIGHT';
Blockly.Infrared_receiver_UP='UP';
Blockly.Infrared_receiver_DOWN='DOWN';
Blockly.Infrared_receiver_OK='OK';
Blockly.Infrared_receiver_BACK='BACK';
Blockly.Infrared_receiver_VOLUP='VOLUP';
Blockly.Infrared_receiver_VOLDOWN='VOLDOWN';
Blockly.Infrared_receiver_MUTE='MUTE';
Blockly.Infrared_receiver_PLAY='PLAY';
...
Blockly.microduinoWatting='Waiting';
Blockly.microduinoWhile='While';
Blockly.RepeatTime='Continued time(ms)';
Blockly.timerName='Time name';
Blockly.microduinoSo='else';
Blockly.microduinoRepeatDoing='Repeat doing';
Blockly.MicroduinoEvery='  Every';
Blockly.MicroduinoStep='Step';
Blockly.millis='Get system run time(ms)';

//----------------Motor------------------//
Blockly.setup_motor='Initialize motor';
Blockly.motorchoose='Select motor';
Blockly.motorA='Motor A';
Blockly.motorB='Motor B';
Blockly.motorSpeed='Motor speed (-255,255)';

//----------------Colorled------------------//

Blockly.ColorLEDInit='Initialize color LED ';
Blockly.ColorLEDNumber='Color LED number:';
Blockly.ColorLEDPin='Control pin:';
Blockly.ColorLEDOneControl='Color LED control  No.';
Blockly.ColorOneIndex='color LED ';
Blockly.ColorLEDAllControl='All color LED control ';
Blockly.ColorLEDSingle='Single-color effect';
Blockly.ColorLEDRainbow='Rain bow effect' ;
Blockly.ColorLEDBreath='Breath effect';
Blockly.ColorLEDBlink='Blink effect';
Blockly.LEDBreathingTime='Time(ms)';
Blockly.ColorLEDBlinkIndex='Blinking time';
Blockly.ColorSet=' Color';


//----------------BUZZER------------------//
Blockly.BuzzerInit='Initialize buzzer';
Blockly.Buzzer='Buzzer on';
Blockly.BuzzerNoTone='Buzzer off';
Blockly.BuzzerNum='Nomber';
Blockly.BuzzerPin='Buzzer pin';
Blockly.Frequency='Buzzer frequency';
Blockly.BuzzerMelody='Buzzer melody';
Blockly.BuzzerSong='Buzzer song;'
Blockly.audioDuration='Duration';
Blockly.BuzzerSongreset='End playing';
Blockly.BuzzerStopSong='End playing';
...
//----------------Crash------------------//
Blockly.crashButton='Crash';
Blockly.get_Pin='Pin';
Blockly.Keyget_Check='Detect action';
Blockly.KeyInputPRESS='Press';
Blockly.KeyInputRELEASE='Release';
Blockly.shortPress='Shor press';
Blockly.longPress='Long press';

//----------------Infrared—receiver------------------//
Blockly.IRReciverInitC='Initialize IR';
Blockly.IRReciverEnable='Enable IR';
Blockly.IRReciverData='Receive data';

//----------------Light------------------//
Blockly.LightSensor='Light sensor';
Blockly.LightSensorValue='-ligh intensity'
Blockly.dataInterval='between the data range from';
Blockly.dataTodata='to';

//----------------LineFinder-----------------//
Blockly.LineFinder='Line finder';
Blockly.returndata='Get';
Blockly.IRRactionDistance='Distance';
Blockly.IRRactionBlack='Grey level';

//----------------Mic-----------------//
Blockly.MicInit='Initialize mic';
Blockly.Mic='Sound intensity';
