...
var MSG = {
  ...
  IBCModule:"模块",
  IBCModule_Core:"核心模块",
  IBCModule_Motor:"电机模块",
  IBCSensor:"传感器",
  IBCSensor_Colorled:"多彩LED",
  IBCSensor_Buzzer:"蜂鸣器",
  IBCSensor_Crash:"碰撞开关",
  IBCSensor_LineFinder:"灰度循迹",
  IBCSensor_Mic:"声音强度",
  IBCSensor_Light:"光照模拟",
  IBCSensor_Infrared_receiver:"红外接收",
  catLuxe:"泺喜机器人",
  tab_blocks: "模块",
  tab_arduino: "代码",
...
Blockly.REMOTE_CONTRO_KEY = '接收遥控器信号';
Blockly.Infrared_receiver_POWER='电源';
...
Blockly.Infrared_receiver_LEFT='左';
Blockly.Infrared_receiver_RIGHT='右';
Blockly.Infrared_receiver_UP='上';
Blockly.Infrared_receiver_DOWN='下';
Blockly.Infrared_receiver_OK='OK';
Blockly.Infrared_receiver_BACK='返回';
Blockly.Infrared_receiver_VOLUP='声音+';
Blockly.Infrared_receiver_VOLDOWN='声音-';
Blockly.Infrared_receiver_MUTE='主菜单';
Blockly.Infrared_receiver_PLAY='播放';
...
/****
add by Microduino for IBC chinese
****/
//----------------Core------------------//
...
Blockly.RepeatTime='持续时间(ms)';
Blockly.timerName='时间名字';
Blockly.MicroduinoEvery='  每';
Blockly.MicroduinoStep='步';
Blockly.millis='获取系统运行时间(毫秒)';

//----------------Motor------------------//
Blockly.setup_motor='初始化电机';
Blockly.motorchoose='电机选择';
Blockly.motorA='电机A';
Blockly.motorB='电机B';
Blockly.motorSpeed='电机速度(-255,255)';

//----------------Colorled------------------//
Blockly.ColorLEDInit='初始化彩灯 ';
Blockly.ColorLEDNumber='彩灯总数:';
Blockly.ColorLEDPin='控制管脚:';
Blockly.ColorLEDOneControl='彩灯控制  第';
Blockly.ColorLEDAllControl='彩灯控制  所有灯 ';
Blockly.ColorLEDSingle='单色效果';
Blockly.ColorLEDRainbow='彩虹效果';
Blockly.ColorLEDBreath='呼吸效果';
Blockly.ColorLEDBlink='闪烁效果';
Blockly.LEDBreathingTime='时间(毫秒)';
Blockly.ColorLEDBlinkIndex='闪烁次数';
Blockly.ColorSet=' 颜色 ';
Blockly.ColorOneIndex='号彩灯 ';

//----------------BUZZER------------------//
Blockly.BuzzerInit='初始化蜂鸣器';
Blockly.Buzzer='蜂鸣器开';
...
Blockly.audioDuration='时长';
Blockly.BuzzerSongreset='歌曲播放结束';
Blockly.BuzzerStopSong='停止播放歌曲';
Blockly.low1DO='低音 1DO';
Blockly.low2RE='低音 2RE';
Blockly.low3MI='低音 3MI';
Blockly.low4FA='低音 4FA';
Blockly.low5SO='低音 5SO';
Blockly.low6LA='低音 6LA';
Blockly.low7XI='低音 7XI';
Blockly.midlle1DO='中音 1DO';
Blockly.midlle2RE='中音 2RE';
Blockly.midlle3MI='中音 3MI';
Blockly.midlle4FA='中音 4FA';
Blockly.midlle5SO='中音 5SO';
Blockly.midlle6LA='中音 6LA';
Blockly.midlle7XI='中音 7XI';
Blockly.high1DO='高音 1DO';
Blockly.high2RE='高音 2RE';
Blockly.high3MI='高音 3MI';
Blockly.high4FA='高音 4FA';
Blockly.high5SO='高音 5SO';
Blockly.high6LA='高音 6LA';
Blockly.high7XI='高音 7XI';
...
//----------------Infrared—receiver------------------//
Blockly.IRReciverInitC='红外接收初始化';
Blockly.IRReciverEnable='红外接收恢复';
Blockly.IRReciverData='接收数据';

//----------------Light------------------//
Blockly.LightSensor='光线传感器';
Blockly.LightSensorValue='-光强'
Blockly.dataInterval='满足数据区间';
Blockly.dataTodata='至';

//----------------LineFinder-----------------//
Blockly.LineFinder='灰度循迹';
Blockly.returndata='获取';
Blockly.IRRactionDistance='距离';
Blockly.IRRactionBlack='灰度';

//----------------Mic-----------------//
Blockly.MicInit='初始化声音传感器';
Blockly.Mic='声音强度';
