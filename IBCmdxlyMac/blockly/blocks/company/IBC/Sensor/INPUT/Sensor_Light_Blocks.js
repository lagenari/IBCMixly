...
Blockly.Blocks.Sensor_Light_analog = {
  init: function() {
    ...
    this.appendDummyInput()
    .appendTitle(Blockly.returndata+Blockly.LightSensorValue);
...
Blockly.Blocks.Sensor_Light_Key = {
  init: function() {
    this.setColour(colorSet);
    this.appendDummyInput("")
    .appendField(new Blockly.FieldImage("../../media/Microduino/ALight.png", 40, 30))
    ...
    var tip="定义光照模拟传感器的引脚和事件类型并且判断数据区间\n";
    tip+="模拟接口\n";
    this.setTooltip(tip);
